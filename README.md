...
## 备份原版渲染器文件夹
  ...
  2. 创建`backup.bat` (在本文末尾有教程)，代码：
      ...
      exit
      ```
      或者直接<a href="https://github.com/UMSCJK/MCLauncher-tutorial/blob/main/bat/backup.bat" download>点击下载现成的backup.bat</a>
...
## 还原渲染器文件夹
  1. 创建`reset.bat` (在本文末尾有教程)，代码：
      ...
      exit
      ```
      或者直接<a href="https://github.com/UMSCJK/MCLauncher-tutorial/blob/main/bat/reset.bat" download>点击下载现成的reset.bat</a>
