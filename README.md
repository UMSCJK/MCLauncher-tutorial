...
<img src="https://kgithub.com/UMSCJK/MCLauncher-tutorial/blob/main/img/mclauncher.png" style="width: 75%;">
...
- 使用之前备份好`com.mojang`文件夹
  ...
  - 进入方法：按住键盘上的`Win+R`打开“运行”对话框，在输入框中粘贴上述路径，然后点击`确定`或按下`回车`键<br>
    <img src="https://kgithub.com/UMSCJK/MCLauncher-tutorial/blob/main/img/run-com.mojang.png" style="width: 40%;">
...
- 已启用Windows开发人员模式 (按住键盘上的`Win+I`打开`Windows设置-更新与安全-开发者选项-开发人员模式`，Windows 11中在`Windows设置-隐私与安全性-开发人员模式`)
  ...
  <img src="https://kgithub.com/UMSCJK/MCLauncher-tutorial/blob/main/img/dev21h2.png" style="width: 32%; padding: 2px"><img src="https://kgithub.com/UMSCJK/MCLauncher-tutorial/blob/main/img/dev1809.png" style="width: 32%; padding: 2px"><img src="https://kgithub.com/UMSCJK/MCLauncher-tutorial/blob/main/img/dev22h2.png" style="width: 32%; padding: 2px">
  </div>
## 软件下载
### MCLauncher
...
### 【不推荐】MCLauncher自带下载
  ...
  - 如果MCLauncher启动非常慢，最后弹出一个报错弹窗：<br>
    <img src="https://kgithub.com/UMSCJK/MCLauncher-tutorial/blob/main/img/error.png" style="width: 40%;">
...
## 替换光影
  ...
  2. 光影版本和MC版本的兼容情况<br>
      <img src="https://kgithub.com/UMSCJK/MCLauncher-tutorial/blob/main/img/table.png">
...
## 提示程序包依赖于一个找不到的框架怎么办？
  ...
  <img src="https://kgithub.com/UMSCJK/MCLauncher-tutorial/blob/main/img/frame.png" style="width: 40%;">
  ...
  5. 安装两个appx应用包 (在此提供一种通用的方法)
      1. 打开PowerShell
          ...
          <img src="https://kgithub.com/UMSCJK/MCLauncher-tutorial/blob/main/img/run-powershell.png" style="width: 40%;">

          - 方法二：按住键盘上的`Shift`键并在资源管理器文件夹窗口内的空白处点击鼠标右键或按动键盘上的`Shift+F10`，点击`在此处打开 PowerShell 窗口`或按下键盘上的`S`键<br>
          <img src="https://kgithub.com/UMSCJK/MCLauncher-tutorial/blob/main/img/shift_r_click.png" style="width: 40%;">
...
## 提示程序包与设备不兼容怎么办？
  报错信息如图 (可能会有部分版本号不一样)<br>
  <img src="https://kgithub.com/UMSCJK/MCLauncher-tutorial/blob/main/img/version.png" style="width: 40%;">
